export function constructOtpMfaTemplate(EXPIRE_TIME: string, OTP_CODE: string) {
	return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Sijill MFA Verification</title>
<style>
...
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      <p>Hi,</p>
      <p>To secure your account, please use the OTP below to complete your sign-in:</p>
      <div class="otp-container">
        ${OTP_CODE.split('')
					.map((d) => `<div class="otp-digit">${d}</div>`)
					.join('')}
      </div>
      <p class="expiry">Expires in ${EXPIRE_TIME}</p>
